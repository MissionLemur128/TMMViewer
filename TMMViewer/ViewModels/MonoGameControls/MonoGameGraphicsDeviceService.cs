...
public class MonoGameGraphicsDeviceService : IGraphicsDeviceService, IDisposable
{
    ...
    public void StartDirect3D(Window window)
    {
        ...
        Direct3DDevice = new DeviceEx(Direct3DContext, 0, DeviceType.Hardware, nint.Zero,
    ...
    public GraphicsDevice CreateGraphicsDevice(nint windowHandle, int width, int height)
    {
